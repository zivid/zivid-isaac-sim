...
from isaacsim.zivid.camera import ZividCameraModelName, spawn_zivid_casing
...
def assemble_zivid_casing_on_robot(  # pylint: disable=too-many-arguments
...
def _assemble_zivid_on_robot(
    ...
    *,
    ...
    zivid_prim = spawn_zivid_casing(model_name, zivid_prim_path, zivid_world_pose, make_rigid_body=True)
