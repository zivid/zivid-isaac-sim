...
class OmniverseCameraParams:
    ...
    @staticmethod
    def from_intrinsic_matrix(  # pylint: disable=too-many-arguments,too-many-positional-arguments
...
def apply_model_params_to_camera(
    ...
    camera.set_focus_distance(model_params.focus_distance)
...
def hide_camera_icon(camera: Camera) -> None:
    omni.kit.commands.execute(
